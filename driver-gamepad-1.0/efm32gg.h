...
#define TIMER1_IFS ((volatile uint32_t*)(TIMER1_BASE + 0x14))
...
#define TIMER2_CMD ((volatile uint32_t*)(TIMER1_BASE + 0x04))
#define TIMER2_IEN ((volatile uint32_t*)(TIMER1_BASE + 0x0c))
#define TIMER2_IFC ((volatile uint32_t*)(TIMER1_BASE + 0x18))
#define TIMER2_TOP ((volatile uint32_t*)(TIMER1_BASE + 0x1c))
#define TIMER2_CNT ((volatile uint32_t*)(TIMER1_BASE + 0x24))
...
#define DMA_CH1_CTRL    ((volatile uint32_t*)(DMA_BASE + 0x1110))
